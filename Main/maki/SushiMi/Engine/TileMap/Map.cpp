		...
		for (int c = 0; c < max_grid_rows_y; c++)
		{
			for (int r = 0; r < max_grid_cols_x; r++)
			{
				...
				case static_cast<int>(animated::GunkanCarrot):
				{
					...
					//Fishing_Top_0_0
					case static_cast<int>(animated::Fishing_Top_0_0):
					{
						Sprite* rice1 = new Sprite("../textures/StaticTop/Fishing_top/Fishing_Top_0_0.png");
						std::pair<animated, Sprite*> combine1 = std::make_pair(animated::Fishing_Top_0_0, std::move(rice1));
						rice1->Add_animation("../textures/spritesheet/AnimatedTop/25Frames.txt");
						rice1->curr_anim = AnimationType::Idle;
						rice1->isSpriteSheet = 1;
						SceneManager::loadTopAnimation(grid_to_coord_x, grid_to_coord_y, combine1);
					...
					//Fishing_Top_1_1
					case static_cast<int>(animated::Fishing_Top_1_1):
					{
						Sprite* rice1 = new Sprite("../textures/StaticTop/Fishing_top/Fishing_Top_1_1.png");
						std::pair<animated, Sprite*> combine1 = std::make_pair(animated::Fishing_Top_1_1, std::move(rice1));
						rice1->Add_animation("../textures/spritesheet/AnimatedTop/25Frames.txt");
						rice1->curr_anim = AnimationType::Idle;
						rice1->isSpriteSheet = 1;
						SceneManager::loadTopAnimation(grid_to_coord_x, grid_to_coord_y, combine1);
					...
					//Fishing_Top_1_2
					case static_cast<int>(animated::Fishing_Top_1_2):
					{
						Sprite* rice1 = new Sprite("../textures/StaticTop/Fishing_top/Fishing_Top_1_2.png");
						std::pair<animated, Sprite*> combine1 = std::make_pair(animated::Fishing_Top_1_2, std::move(rice1));
						rice1->Add_animation("../textures/spritesheet/AnimatedTop/25Frames.txt");
						rice1->curr_anim = AnimationType::Idle;
						rice1->isSpriteSheet = 1;
						SceneManager::loadTopAnimation(grid_to_coord_x, grid_to_coord_y, combine1);
					...
					//Fishing_Top_1_3
					case static_cast<int>(animated::Fishing_Top_1_3):
					{
						Sprite* rice1 = new Sprite("../textures/StaticTop/Fishing_top/Fishing_Top_1_3.png");
						std::pair<animated, Sprite*> combine1 = std::make_pair(animated::Fishing_Top_1_3, std::move(rice1));
						rice1->Add_animation("../textures/spritesheet/AnimatedTop/25Frames.txt");
						rice1->curr_anim = AnimationType::Idle;
						rice1->isSpriteSheet = 1;
						SceneManager::loadTopAnimation(grid_to_coord_x, grid_to_coord_y, combine1);
					...
					//Fishing_Top_1_4
					case static_cast<int>(animated::Fishing_Top_1_4):
					{
						Sprite* rice1 = new Sprite("../textures/StaticTop/Fishing_top/Fishing_Top_1_4.png");
						std::pair<animated, Sprite*> combine1 = std::make_pair(animated::Fishing_Top_1_4, std::move(rice1));
						rice1->Add_animation("../textures/spritesheet/AnimatedTop/25Frames.txt");
						rice1->curr_anim = AnimationType::Idle;
						rice1->isSpriteSheet = 1;
						SceneManager::loadTopAnimation(grid_to_coord_x, grid_to_coord_y, combine1);
					...
					//Fishing_Top_2_1
					case static_cast<int>(animated::Fishing_Top_2_1):
					{
						Sprite* rice1 = new Sprite("../textures/StaticTop/Fishing_top/Fishing_Top_2_1.png");
						std::pair<animated, Sprite*> combine1 = std::make_pair(animated::Fishing_Top_2_1, std::move(rice1));
						rice1->Add_animation("../textures/spritesheet/AnimatedTop/25Frames.txt");
						rice1->curr_anim = AnimationType::Idle;
						rice1->isSpriteSheet = 1;
						SceneManager::loadTopAnimation(grid_to_coord_x, grid_to_coord_y, combine1);
					...
					//Fishing_Top_2_2
					case static_cast<int>(animated::Fishing_Top_2_2):
					{
						Sprite* rice1 = new Sprite("../textures/StaticTop/Fishing_top/Fishing_Top_2_2.png");
						std::pair<animated, Sprite*> combine1 = std::make_pair(animated::Fishing_Top_2_2, std::move(rice1));
						rice1->Add_animation("../textures/spritesheet/AnimatedTop/25Frames.txt");
						rice1->curr_anim = AnimationType::Idle;
						rice1->isSpriteSheet = 1;
						SceneManager::loadTopAnimation(grid_to_coord_x, grid_to_coord_y, combine1);
					...
					//Fishing_Top_2_3
					case static_cast<int>(animated::Fishing_Top_2_3):
					{
						Sprite* rice1 = new Sprite("../textures/StaticTop/Fishing_top/Fishing_Top_2_3.png");
						std::pair<animated, Sprite*> combine1 = std::make_pair(animated::Fishing_Top_2_3, std::move(rice1));
						rice1->Add_animation("../textures/spritesheet/AnimatedTop/25Frames.txt");
						rice1->curr_anim = AnimationType::Idle;
						rice1->isSpriteSheet = 1;
						SceneManager::loadTopAnimation(grid_to_coord_x, grid_to_coord_y, combine1);
					...
					//Fishing_Top_2_4
					case static_cast<int>(animated::Fishing_Top_2_4):
					{
						Sprite* rice1 = new Sprite("../textures/StaticTop/Fishing_top/Fishing_Top_2_4.png");
						std::pair<animated, Sprite*> combine1 = std::make_pair(animated::Fishing_Top_2_4, std::move(rice1));
						rice1->Add_animation("../textures/spritesheet/AnimatedTop/25Frames.txt");
						rice1->curr_anim = AnimationType::Idle;
						rice1->isSpriteSheet = 1;
						SceneManager::loadTopAnimation(grid_to_coord_x, grid_to_coord_y, combine1);
					...
					//Fishing_Top_3_1
					case static_cast<int>(animated::Fishing_Top_3_1):
					{
						Sprite* rice1 = new Sprite("../textures/StaticTop/Fishing_top/Fishing_Top_3_1.png");
						std::pair<animated, Sprite*> combine1 = std::make_pair(animated::Fishing_Top_3_1, std::move(rice1));
						rice1->Add_animation("../textures/spritesheet/AnimatedTop/25Frames.txt");
						rice1->curr_anim = AnimationType::Idle;
						rice1->isSpriteSheet = 1;
						SceneManager::loadTopAnimation(grid_to_coord_x, grid_to_coord_y, combine1);
					...
					//Fishing_Top_3_2
					case static_cast<int>(animated::Fishing_Top_3_2):
					{
						Sprite* rice1 = new Sprite("../textures/StaticTop/Fishing_top/Fishing_Top_3_2.png");
						std::pair<animated, Sprite*> combine1 = std::make_pair(animated::Fishing_Top_3_2, std::move(rice1));
						rice1->Add_animation("../textures/spritesheet/AnimatedTop/25Frames.txt");
						rice1->curr_anim = AnimationType::Idle;
						rice1->isSpriteSheet = 1;
						SceneManager::loadTopAnimation(grid_to_coord_x, grid_to_coord_y, combine1);
					...
					//Fishing_Top_3_3
					case static_cast<int>(animated::Fishing_Top_3_3):
					{
						Sprite* rice1 = new Sprite("../textures/StaticTop/Fishing_top/Fishing_Top_3_3.png");
						std::pair<animated, Sprite*> combine1 = std::make_pair(animated::Fishing_Top_3_3, std::move(rice1));
						rice1->Add_animation("../textures/spritesheet/AnimatedTop/25Frames.txt");
						rice1->curr_anim = AnimationType::Idle;
						rice1->isSpriteSheet = 1;
						SceneManager::loadTopAnimation(grid_to_coord_x, grid_to_coord_y, combine1);
					...
					//Fishing_Top_3_4
					case static_cast<int>(animated::Fishing_Top_3_4):
					{
						Sprite* rice1 = new Sprite("../textures/StaticTop/Fishing_top/Fishing_Top_3_4.png");
						std::pair<animated, Sprite*> combine1 = std::make_pair(animated::Fishing_Top_3_4, std::move(rice1));
						rice1->Add_animation("../textures/spritesheet/AnimatedTop/25Frames.txt");
						rice1->curr_anim = AnimationType::Idle;
						rice1->isSpriteSheet = 1;
						SceneManager::loadTopAnimation(grid_to_coord_x, grid_to_coord_y, combine1);
					...
					//Fishing_LifeBuoy_Red,	
					case static_cast<int>(animated::Fishing_LifeBuoy_Red):
					{
						Sprite* rice1 = new Sprite("../textures/StaticTop/Fishing_top/Fishing_LifeBuoy_Red.png");
						std::pair<animated, Sprite*> combine1 = std::make_pair(animated::Fishing_LifeBuoy_Red, std::move(rice1));
						rice1->Add_animation("../textures/spritesheet/AnimatedTop/25Frames.txt");
						rice1->curr_anim = AnimationType::Idle;
						rice1->isSpriteSheet = 1;
						SceneManager::loadTopAnimation(grid_to_coord_x, grid_to_coord_y, combine1);
					...
					//Fishing_LifeBuoy_Blue,
					case static_cast<int>(animated::Fishing_LifeBuoy_Blue):
					{
						Sprite* rice1 = new Sprite("../textures/StaticTop/Fishing_top/Fishing_LifeBuoy_Blue.png");
						std::pair<animated, Sprite*> combine1 = std::make_pair(animated::Fishing_LifeBuoy_Blue, std::move(rice1));
						rice1->Add_animation("../textures/spritesheet/AnimatedTop/25Frames.txt");
						rice1->curr_anim = AnimationType::Idle;
						rice1->isSpriteSheet = 1;
						SceneManager::loadTopAnimation(grid_to_coord_x, grid_to_coord_y, combine1);
					...
					case static_cast<int>(animated::Fishing_LifeBuoy_Green):
					{
						Sprite* rice1 = new Sprite("../textures/StaticTop/Fishing_top/Fishing_LifeBuoy_Green.png");
						std::pair<animated, Sprite*> combine1 = std::make_pair(animated::Fishing_LifeBuoy_Green, std::move(rice1));
						rice1->Add_animation("../textures/spritesheet/AnimatedTop/25Frames.txt");
						rice1->curr_anim = AnimationType::Idle;
						rice1->isSpriteSheet = 1;
						SceneManager::loadTopAnimation(grid_to_coord_x, grid_to_coord_y, combine1);
					...
					//Fishing_LifeBuoy_Orange,
					case static_cast<int>(animated::Fishing_LifeBuoy_Orange):
					{
						Sprite* rice1 = new Sprite("../textures/StaticTop/Fishing_top/Fishing_LifeBuoy_Orange.png");
						std::pair<animated, Sprite*> combine1 = std::make_pair(animated::Fishing_LifeBuoy_Orange, std::move(rice1));
						rice1->Add_animation("../textures/spritesheet/AnimatedTop/25Frames.txt");
						rice1->curr_anim = AnimationType::Idle;
						rice1->isSpriteSheet = 1;
						SceneManager::loadTopAnimation(grid_to_coord_x, grid_to_coord_y, combine1);
					...
					//Fishing_Wood_1,		
					case static_cast<int>(animated::Fishing_Wood_1):
					{
						Sprite* rice1 = new Sprite("../textures/StaticTop/Fishing_top/Fishing_Wood_1.png");
						std::pair<animated, Sprite*> combine1 = std::make_pair(animated::Fishing_Wood_1, std::move(rice1));
						rice1->Add_animation("../textures/spritesheet/AnimatedTop/25Frames.txt");
						rice1->curr_anim = AnimationType::Idle;
						rice1->isSpriteSheet = 1;
						SceneManager::loadTopAnimation(grid_to_coord_x, grid_to_coord_y, combine1);
					...
					//Fishing_Wood_2,	
					case static_cast<int>(animated::Fishing_Wood_2):
					{
						Sprite* rice1 = new Sprite("../textures/StaticTop/Fishing_top/Fishing_Wood_2.png");
						std::pair<animated, Sprite*> combine1 = std::make_pair(animated::Fishing_Wood_2, std::move(rice1));
						rice1->Add_animation("../textures/spritesheet/AnimatedTop/25Frames.txt");
						rice1->curr_anim = AnimationType::Idle;
						rice1->isSpriteSheet = 1;
						SceneManager::loadTopAnimation(grid_to_coord_x, grid_to_coord_y, combine1);
					...
					//Fishing_Wood_3	
					case static_cast<int>(animated::Fishing_Wood_3):
					{
						Sprite* rice1 = new Sprite("../textures/StaticTop/Fishing_top/Fishing_Wood_3.png");
						std::pair<animated, Sprite*> combine1 = std::make_pair(animated::Fishing_Wood_3, std::move(rice1));
						rice1->Add_animation("../textures/spritesheet/AnimatedTop/25Frames.txt");
						rice1->curr_anim = AnimationType::Idle;
						rice1->isSpriteSheet = 1;
						SceneManager::loadTopAnimation(grid_to_coord_x, grid_to_coord_y, combine1);
		...
		for (int c = 0; c < max_grid_rows_y; c++)
		{
			for (int r = 0; r < max_grid_cols_x; r++)
			{
				...
				case static_cast<int>(grid_number::avocado):
				{
					...
					{
						avocado = new Sprite("../textures/spritesheet/MakiCity_avocadospritesheet.png");
						/*add avocado sprites*/
						avocado->Add_animation("../textures/spritesheet/MakiCity_Avocado_normal.txt");
						avocado->Add_animation("../textures/spritesheet/MakiCity_Avocado_soy.txt");
						avocado->Add_animation("../textures/spritesheet/MakiCity_Avocado_wasabi.txt");
						avocado->Add_animation("../textures/spritesheet/MakiCity_Avocado_both.txt");
					}
					std::pair<grid_number, Sprite*> combine = std::make_pair(grid_number::avocado, avocado);
					avocado->status = 0;
				...
				case static_cast<int>(grid_number::corn):
				{
					...
					if (maki_city != 1)
					{
						corn = new Sprite("../textures/spritesheet/cornspritesheet.png");
						/*add corn sprites*/
						corn->Add_animation("../textures/spritesheet/corn_normal.txt");
						corn->Add_animation("../textures/spritesheet/corn_soy.txt");
						corn->Add_animation("../textures/spritesheet/corn_wasabi.txt");
						corn->Add_animation("../textures/spritesheet/corn_both.txt");
					}
					else
					{
						corn = new Sprite("../textures/spritesheet/MakiCity_cornspritesheet.png");
						/*add corn sprites*/
						corn->Add_animation("../textures/spritesheet/MakiCity_corn_normal.txt");
						corn->Add_animation("../textures/spritesheet/MakiCity_corn_soy.txt");
						corn->Add_animation("../textures/spritesheet/MakiCity_corn_wasabi.txt");
						corn->Add_animation("../textures/spritesheet/MakiCity_corn_both.txt");

					}
					std::pair<grid_number, Sprite*> combine = std::make_pair(grid_number::corn, corn);
					corn->status = 0;
					corn->isSpriteSheet = 1;
					corn->curr_anim = AnimationType::Idle;
					SceneManager::loadIngr(grid_to_coord_x, grid_to_coord_y, r, c, combine);
				...
				case static_cast<int>(grid_number::inari):
				{
					...
					if (maki_city != 1)
					{
						inari = new Sprite("../textures/spritesheet/inarispritesheet.png");
						/*add inari sprites*/
						inari->Add_animation("../textures/spritesheet/inari_normal.txt");
						inari->Add_animation("../textures/spritesheet/inari_soy.txt");
						inari->Add_animation("../textures/spritesheet/inari_wasabi.txt");
						inari->Add_animation("../textures/spritesheet/inari_both.txt");
					}
					else
					{
						inari = new Sprite("../textures/spritesheet/MakiCity_inarispritesheet.png");
						/*add inari sprites*/
						inari->Add_animation("../textures/spritesheet/MakiCity_Inari_normal.txt");
						inari->Add_animation("../textures/spritesheet/MakiCity_Inari_soy.txt");
						inari->Add_animation("../textures/spritesheet/MakiCity_Inari_wasabi.txt");
						inari->Add_animation("../textures/spritesheet/MakiCity_Inari_both.txt");

					}
					std::pair<grid_number, Sprite*> combine = std::make_pair(grid_number::inari, inari);
					inari->status = 0;
					inari->isSpriteSheet = 1;
					inari->curr_anim = AnimationType::Idle;
					SceneManager::loadIngr(grid_to_coord_x, grid_to_coord_y, r, c, combine);
				...
				{
					Sprite* octopus = nullptr;
					if (maki_city != 1)
					{
						octopus = new Sprite("../textures/spritesheet/octopusspritesheet.png");
						/*add octopus sprites*/
						octopus->Add_animation("../textures/spritesheet/octopus_normal.txt");
						octopus->Add_animation("../textures/spritesheet/octopus_soy.txt");
						octopus->Add_animation("../textures/spritesheet/octopus_wasabi.txt");
						octopus->Add_animation("../textures/spritesheet/octopus_both.txt");
					}
					else
					{
						octopus = new Sprite("../textures/spritesheet/MakiCity_octopusspritesheet.png");
						/*add octopus sprites*/
						octopus->Add_animation("../textures/spritesheet/MakiCity_Octopus_normal.txt");
						octopus->Add_animation("../textures/spritesheet/MakiCity_Octopus_soy.txt");
						octopus->Add_animation("../textures/spritesheet/MakiCity_Octopus_wasabi.txt");
						octopus->Add_animation("../textures/spritesheet/MakiCity_Octopus_both.txt");

					}
					std::pair<grid_number, Sprite*> combine = std::make_pair(grid_number::octopus, octopus);
					octopus->status = 0;
					octopus->isSpriteSheet = 1;
					octopus->curr_anim = AnimationType::Idle;
					SceneManager::loadIngr(grid_to_coord_x, grid_to_coord_y, r, c, combine);
				...
				case static_cast<int>(grid_number::roes):
				{
					...
					if (maki_city != 1)
					{
						roes = new Sprite("../textures/spritesheet/roespritesheet.png");
						/*add roes sprites*/
						roes->Add_animation("../textures/spritesheet/roe_normal.txt");
						roes->Add_animation("../textures/spritesheet/roe_soy.txt");
						roes->Add_animation("../textures/spritesheet/roe_wasabi.txt");
						roes->Add_animation("../textures/spritesheet/roe_both.txt");
					}
					else
					{
		...
		if (!isStuck())
		{
					...
					wGrids[Window::player->player_grid_pos.x - 1][Window::player->player_grid_pos.y] < static_cast<int>(wall_type::last)))
			{
					...
					gGrids[Window::player->player_grid_pos.x - 1][Window::player->player_grid_pos.y] <= static_cast<int>(grid_number::nori))
				{
					...
					//check if tile on the left of ingredent is soya
					else if (gGrids[Window::player->player_grid_pos.x - 2][Window::player->player_grid_pos.y] == static_cast<int>(grid_number::soya) &&
						gGrids[Window::player->player_grid_pos.x - 1][Window::player->player_grid_pos.y] >= static_cast<int>(grid_number::octopus) && 
						gGrids[Window::player->player_grid_pos.x - 1][Window::player->player_grid_pos.y] <= static_cast<int>(grid_number::salmon))
					{
						...
						for (auto ingredient : SceneManager::ingredientcontainer)
						{
							if (ingredient.nametag == check)
							{
								...
								{
									/*change sprite to with soya*/
									ingredient.spr->status = 1;
									ingredient.spr->curr_anim = AnimationType::Run;
								}
								else if (ingredient.spr->status == 2)
								{
									ingredient.spr->status = 3;
									ingredient.spr->curr_anim = AnimationType::Both;
								}
								break;
							}
						}
					...
					//check if tile on left of ingredient is Wasabi
						...
						for (auto ingredient : SceneManager::ingredientcontainer)
						{
							if (ingredient.nametag == check)
							{
								...
								if (ingredient.spr->status == 0)
								{
									...
									ingredient.spr->status = 2;
									ingredient.spr->curr_anim = AnimationType::Jump;
								}
								else if (ingredient.spr->status == 1)
								{
					...
					//check if tile on left of ingredient is tea
					...
					gGrids[Window::player->player_grid_pos.x - 1][Window::player->player_grid_pos.y] <= static_cast<int>(grid_number::salmon))
					{
							...
							for (auto ingredient : SceneManager::ingredientcontainer)
							{
								...
								{
									ingredient.spr->transformation.Position.x -= tile_width;
									/*change ingredient sprite to nothing*/
									if (ingredient.spr->status != 0)
									{
										ingredient.spr->status = 0;
									}
		...
		if (!isStuck())
		{
					...
					wGrids[Window::player->player_grid_pos.x + 1][Window::player->player_grid_pos.y] < static_cast<int>(wall_type::last)))
			{
					...
					gGrids[Window::player->player_grid_pos.x + 1][Window::player->player_grid_pos.y] <= static_cast<int>(grid_number::nori))
				{
					...
					/*------------------------------soya/Wasabi/Tea Checks HERE----------------------------------------------------------------------------------------*/
					//check if tile on the right of ingredient is soya
					else if (gGrids[Window::player->player_grid_pos.x + 2][Window::player->player_grid_pos.y] == static_cast<int>(grid_number::soya) &&
						gGrids[Window::player->player_grid_pos.x + 1][Window::player->player_grid_pos.y] >= static_cast<int>(grid_number::octopus) &&
						gGrids[Window::player->player_grid_pos.x + 1][Window::player->player_grid_pos.y] <= static_cast<int>(grid_number::salmon))
					{
					...
					//check if tile on right of ingredient is Wasabi
					else if (gGrids[Window::player->player_grid_pos.x + 2][Window::player->player_grid_pos.y] == static_cast<int>(grid_number::wasabi) &&
					gGrids[Window::player->player_grid_pos.x + 1][Window::player->player_grid_pos.y] >= static_cast<int>(grid_number::octopus) &&
					gGrids[Window::player->player_grid_pos.x + 1][Window::player->player_grid_pos.y] <= static_cast<int>(grid_number::salmon))
					{
					...
					//check if tile on right of ingredient is tea
					else if (gGrids[Window::player->player_grid_pos.x + 2][Window::player->player_grid_pos.y] == static_cast<int>(grid_number::tea) &&
					gGrids[Window::player->player_grid_pos.x + 1][Window::player->player_grid_pos.y] >= static_cast<int>(grid_number::octopus) &&
					gGrids[Window::player->player_grid_pos.x + 1][Window::player->player_grid_pos.y] <= static_cast<int>(grid_number::salmon))
						{
		...
		if (!isStuck())
		{
					...
					wGrids[Window::player->player_grid_pos.x][Window::player->player_grid_pos.y + 1] < static_cast<int>(wall_type::last)))
			{
					...
					gGrids[Window::player->player_grid_pos.x][Window::player->player_grid_pos.y + 1] <= static_cast<int>(grid_number::nori))
				{
					...
					/*------------------------------soya/Wasabi/Tea Checks HERE----------------------------------------------------------------------------------------*/
					//check if tile on the bottom of ingredient is soya
					else if (gGrids[Window::player->player_grid_pos.x][Window::player->player_grid_pos.y + 2] == static_cast<int>(grid_number::soya) &&
						gGrids[Window::player->player_grid_pos.x][Window::player->player_grid_pos.y + 1] >= static_cast<int>(grid_number::octopus) &&
		...
		if (!isStuck())
		{
					...
					wGrids[Window::player->player_grid_pos.x][Window::player->player_grid_pos.y - 1] < static_cast<int>(wall_type::last)))
			{
					...
					gGrids[Window::player->player_grid_pos.x][Window::player->player_grid_pos.y - 1] <= static_cast<int>(grid_number::nori))
				{
					...
					/*------------------------------soya/Wasabi/Tea Checks HERE----------------------------------------------------------------------------------------*/
					//check if tile on the top of ingredient is soya
					else if (gGrids[Window::player->player_grid_pos.x][Window::player->player_grid_pos.y - 2] == static_cast<int>(grid_number::soya) &&
						gGrids[Window::player->player_grid_pos.x][Window::player->player_grid_pos.y - 1] >= static_cast<int>(grid_number::octopus) &&
						gGrids[Window::player->player_grid_pos.x][Window::player->player_grid_pos.y - 1] <= static_cast<int>(grid_number::salmon))
					{
