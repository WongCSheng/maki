...
namespace Core
{
	...
	void Levels::Level2()
	{
		...
		{
			GameSave::LevelStatusContainer[3].isLevelClear = 1;
			GameSave::LevelStatusContainer[4].isUnlocked = 1; //set next level unlocked
			GameSave::LevelStatusContainer[3].isQuestClear = 1;
