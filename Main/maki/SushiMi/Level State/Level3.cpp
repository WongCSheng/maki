...
namespace Core
{
	...
	void Levels::Level3()
	{
		...
		{
			GameSave::LevelStatusContainer[4].isLevelClear = 1;
			GameSave::LevelStatusContainer[5].isUnlocked = 1; //set next level unlocked
			GameSave::LevelStatusContainer[4].isQuestClear = 1;
