...
namespace Core
{
	...
	void Levels::Level6()
	{
		...
		if (!Window::loaded)
		{
			...
			Window::dialogue_style = static_cast<int>(Window::dialogue::L6);
			Window::curr_len = 0;
		...
		if (Window::isWinCondition == true)
		{
			...
			//press button to undraw level 6, and draw level 7
			if (Window::keystate_space && Window::isWinCondition == true)
			{
				Window::isLevel6 = false; //unload curr level
				Window::isLevel7 = true; //load new level
