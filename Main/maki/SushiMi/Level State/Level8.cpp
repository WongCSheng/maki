...
namespace Core
{
	...
	void Levels::Level8()
	{
		...
		{
			GameSave::LevelStatusContainer[9].isLevelClear = 1;
			GameSave::LevelStatusContainer[10].isUnlocked = 1; //set next level unlocked
			GameSave::LevelStatusContainer[9].isQuestClear = 1;
